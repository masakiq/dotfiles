...
function M.open_github(mode)
  ...
  local github_url = M.repository_url()
  ...
  if mode == 'normal' then
    ...
    github_url = github_url .. "/blob/" .. M.commit() .. M.relative_file_path(absolute_file_path) .. '#L' .. line
  elseif mode == 'visual' then
    ...
    github_url = github_url ..
        "/blob/" .. M.commit() .. M.relative_file_path(absolute_file_path) .. '#L' .. start_line .. '-L' .. end_line
...
function M.relative_file_path(absolute_file_path)
